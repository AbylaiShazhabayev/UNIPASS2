                    ...
                    <div class="row">
                                ...
                                <div class="input-group input-group-flat">
                                    ...
                                    <span class="input-group-text">
                                            <a href="javascript:void(0)" class="link-secondary copy" title=""
                                               data-toggle="tooltip" data-original-title="Copy"><svg
                        ...
                        <div class="col-6 d-none show show-2 show-3 show-4 show-6 show-7">
                            <div class="mb-3 pwd-container">
                                ...
                                <div class="input-group input-group-flat">
                                    <input type="password" class="form-control txtPassword" name="password" maxlength="160" required><span class="input-group-text"><a href="javascript:void(0)"
                                                                                                                                                                       class="link-secondary"
                                                                                                                                                                       id="generatePassword" title=""
                                                                                                                                                                       data-toggle="tooltip"
                                                                                                                                                                       data-original-title="Gerar senha"><svg
                                                xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                                stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"></path><path d="M20 11a8.1 8.1 0 0 0 -15.5 -2m-.5 -5v5h5"></path><path
                                                    d="M4 13a8.1 8.1 0 0 0 15.5 2m.5 5v-5h-5"></path></svg></a><a href="javascript:void(0)" class="link-secondary ml-2" id="showPassword" title=""
                                                                                                                  data-toggle="tooltip" data-original-title="Exibir senha"><svg
                                                xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                                stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"></path><circle cx="12" cy="12" r="2"></circle><path
                                                    d="M2 12l1.5 2a11 11 0 0 0 17 0l1.5 -2"></path><path d="M2 12l1.5 -2a11 11 0 0 1 17 0l1.5 2"></path></svg></a><a href="javascript:void(0)"
                                                                                                                                                                     class="link-secondary copy ml-2"
                                                                                                                                                                     title="" data-toggle="tooltip"
                                                                                                                                                                     data-original-title="Copy"><svg
                                                xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                                stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"></path><rect x="8" y="8" width="12" height="12" rx="2"></rect><path
                                                    d="M16 8v-2a2 2 0 0 0 -2 -2h-8a2 2 0 0 0 -2 2v8a2 2 0 0 0 2 2h2"></path></svg></a></span>
                                </div>
                                <div>
...
<style>
    ...
    .alertooltip:hover .tooltiptext {
        visibility: visible;
    }
</style>
<div id="container" class=" mb-4 animate fade-in d-flex">
    <i class="fa-solid fa-user-lock fa-2xl" style="
        align-self: center;
        font-size: 5rem;
        margin: 0 3rem;
        color: black;
    ...
    <!--        font-size: 1rem;-->
    <!--        margin: 0 3rem;-->
    <!--        color: purple;">Security Center</span>-->
    <div id="cont" data-pct="0">
        <svg id="svg" width="200" height="200" viewPort="0 0 100 100" version="1.1" xmlns="http://www.w3.org/2000/svg">
            <circle r="90" cx="100" cy="100" fill="transparent" stroke-dasharray="565.48" stroke-dashoffset="565.48"></circle>
            <circle id="bar" r="90" cx="100" cy="100" fill="transparent" stroke-dasharray="565.48" stroke-dashoffset="565.48"></circle>
        </svg>
    </div>
    <div class="ml-4" style="align-self: center">
        <h1 class="ml-4">Your Average Security Score</h1>
        <h2 class="ml-4" id="statusText"></h2>
    </div>
</div>
<!--<input id="percent" class="form-control" onchange="setBarPercentage($(this).val())" name="percent">-->
    ...
    <div class="w-25 d-flex flex-column">
        <div class="dropdown-menu dropdown-menu-demo h-100 m-0 border-0"
            ...
            <label class="dropdown-item"><input class="form-check-input m-0 mr-2 filterBy" type="radio" name="filter_by" value="all"
                                                checked>All</label>
            <label class="dropdown-item"><input class="form-check-input m-0 mr-2 filterBy" type="radio" name="filter_by" value="favorites">Favoritesㅤ<i class="fa-solid fa-heart"> </i></label>
            <label class="dropdown-item"><input class="form-check-input m-0 mr-2 filterBy" type="radio" name="filter_by" value="my_passwords">My passwordsㅤ<i class="fa-solid fa-key"></i></label>
            <label class="dropdown-item"><input class="form-check-input m-0 mr-2 filterBy" type="radio" name="filter_by" value="shareds_passwords">Shared with me ㅤ<i
...
<script type="text/javascript">
    $.getScript("{{ asset($assets . '/js/security-center.js?') . $version }}");
</script>
@endsection
